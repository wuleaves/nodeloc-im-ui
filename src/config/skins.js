export const SKIN_KEY = "nodeloc-im-skin";

export const SKINS = {
  dingtalk: {
    label: "钉钉", orgName: "NodeLoc",
...
export function otherThemeActive() {
  return !!document.getElementById("nodeloc-dingtalk-theme") ||
    !!document.getElementById("nodeloc-feishu-theme") ||
